...
public final class singlerooms_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    Connection con = dbc.getCon();
      ...
      out.write("        <title>Single Rooms</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <h1>Single Rooms</h1>\n");
      out.write("        <br>\n");
      ...
      out.write("        ");
            ...
            String query = "SELECT * FROM singleroom";
            ...
            while(rs.next()){
                ...
                out.print("<tr>"
                        +"<form action='singleupdate' method='post'>"
